...
Problem Description:
    ...
    that removing an element from these indices makes the sum of even-indexed 
...
Example Explanation:
    ...
    Removing arr[1] from the array modifies arr[] 
    to { 2, 6, 4 } such that, arr[0] + arr[2] = arr[1]. 
...
function evenPrefix(A){
//
}

module.exports = evenPrefix;
